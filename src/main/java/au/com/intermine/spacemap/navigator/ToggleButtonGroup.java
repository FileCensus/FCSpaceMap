...
public class ToggleButtonGroup extends AbstractNavigatorWidget {
        ...
        this.addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                if (e.getButton() == 1) {
                    ...
                    ToggleButtonGroup.this.repaint();
                }
            }
        });
        ...
        this.addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseMoved(MouseEvent e) {
                ...
                if (item != null) {
                    ...
                    Utils.cursorDefault(ToggleButtonGroup.this);
                }
                calculatePreferredSize(_buttons, getGraphics());
                ToggleButtonGroup.this.repaint();
            }
    ...
    public void setValue(String value) {
        ...
        for (ToggleButton b : _buttons) {
            if (values.contains(b.getTooltip())) {
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < _buttons.size(); ++i) {
            ...
            if (icon != null) {
                ...
                top = (getHeight() / 2) - (icon.getIconHeight() / 2);
                if (top < 0) {
                    top = 0;
                }
            } else {
            ...
            if (item.isSelected()) {
                fillGradient(g, r.x + 1, r.y + 2, r.width - 1, r.height - 4, new GradientPaint(0, 1, _darkShadeColor, 0, getHeight() - 3, (Color) UIManager.getLookAndFeelDefaults().get(
                        "controlShadow")));
            }

            if (icon == null) {
                g.setColor(Color.black);
                DrawingUtils.drawString(g, _labelFont, item.getTooltip(), r.x, r.y, r.width, r.height, DrawingUtils.TEXT_ALIGN_CENTER);
            } else {
